    ...
    docs: {
      description: {
        component: [
          ...
          "is rendered as a badge with a labelled remove button.",
          "",
          "Use this for medium-cardinality selection where users benefit from",
          "search, grouping, async loading, fixed selections, or creatable entries.",
          "For one value, use `Select`; for a small static list, use checkboxes.",
          "",
          ...
          "",
          "Accessibility: pair with a visible `Label`, keep `placeholder` specific,",
          "and provide `emptyIndicator` text that tells users how to recover.",
        ].join("\n"),
      },
    },
  },
